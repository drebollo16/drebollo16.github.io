const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&APPID=8ef3acee6058752fb9adc42140902cd6&units=imperial";
fetch(apiURL)
...
const apiURLs = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&APPID=8ef3acee6058752fb9adc42140902cd6&units=imperial";
fetch(apiURLs)
    .then((response) => response.json())
    .then((jsObject) => {
